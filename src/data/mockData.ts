...
export const INITIAL_MUSICIANS: MusicianProfile[] = [
  {
    id: 'm1',
    name: 'Davide De Luca',
  ...
  },
  {
    ...
    bio: 'Sassofonista tenore e contralto. Esperienza in big band e combo funk. Disponibile per sezioni fiati, jam o registrazioni traccia singola.',
    instruments: [
      { name: 'Sassofono', level: 'Avanzato', isPrimary: true },
      { name: 'Flauto Traverso', level: 'Intermedio' }
    ],
    genres: ['Jazz', 'Funk', 'Blues', 'Ska'],
    availability: 'Disponibile per serate/live',
    experienceYears: 15,
    phoneOrContact: 'alexsax@gmail.com',
    socialLinks: {
      instagram: '@alexsaxo_fi'
    },
    createdAt: '2025-02-25'
  },
  {
    id: 'm7',
    name: 'Valerio Esposito',
    username: 'valeriogtr',
    age: 22,
    gender: 'Uomo',
    city: 'Napoli (NA)',
    ...
    bio: 'Chitarrista metal e progressive shredder con tanta voglia di imparare e suonare dal vivo. Ascolto Dream Theater, Polyphia e Metallica. Cerco elementi con cui spaccare!',
    instruments: [
      { name: 'Chitarra Elettrica', level: 'Avanzato', isPrimary: true },
      { name: 'Basso Elettrico', level: 'Principiante' }
    ],
    genres: ['Heavy Metal', 'Progressive', 'Hard Rock', 'Djent'],
    availability: 'Cerco Band fissa',
    experienceYears: 6,
    phoneOrContact: 'valerio.metal@libero.it',
    socialLinks: {
      instagram: '@valerio_shreds'
    },
    createdAt: '2025-03-01'
  }
];

export const INITIAL_EVENTS: JamEvent[] = [
  {
    id: 'e1',
    ...
    slots: [
      ...
      {
        id: 's4',
        instrument: 'Tastiere/Pianoforte',
        maxCount: 1,
        assignedMusicians: []
      },
      {
      ...
      {
        id: 's6',
        instrument: 'Sassofono / Fiati',
        maxCount: 2,
        assignedMusicians: [
          {
            musicianId: 'm6',
            musicianName: 'Alessio Conti',
            musicianAvatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=400&q=80',
            joinedAt: '2026-09-10'
          }
        ]
      }
  ...
  {
    id: 'e3',
    title: 'Jam Acustica al Parco dei Giardini Margherita',
    description: 'Ritrovo domenicale all’aperto per suonare insieme chitarre acustiche, cajon, voci e percussioni leggere in un’atmosfera rilassata. Ognuno porta il suo strumento.',
    type: 'Aperitivo Musicale',
    date: '2026-09-27',
    time: '17:00',
    locationName: 'Giardini Margherita (Chiosco centrale)',
    address: 'Viale Giovanni Gozzadini',
    city: 'Bologna (BO)',
    genres: ['Acoustic', 'Folk', 'Indie Pop', 'Cantautorato'],
    organizerId: 'm2',
    slots: [
      {
        id: 's11',
      ...
      {
        id: 's12',
        instrument: 'Percussioni / Cajon',
        maxCount: 2,
        assignedMusicians: []
      },
      {
        id: 's13',
        instrument: 'Basso Acustico / Basso',
        maxCount: 1,
        assignedMusicians: [
          {
            musicianId: 'm2',
    ...
    equipmentNotes: 'Evento all’aperto senza prese elettriche, solo strumenti acustici.',
...
export const INITIAL_POSTS: Post[] = [
    ...
    comments: [
      {
        ...
        content: 'Ciao Giulia! Io sono a Torino ma vengo spesso a Bologna per lavoro. Adoro Vulfpeck e Cory Wong! Se fai una jam fammi sapere!',
      ...
      },
      {
        ...
        content: 'Grande! Se ti spingi verso Milano abbiamo bisogno di un basso solido per una serata a fine mese!',
  ...
  },
  {
    ...
    title: 'Jam acustica & cantautorato a Roma centro questo sabato',
    content: 'Ciao ragazzi, sto organizzando un incontro acustico tranquillo nel pomeriggio di sabato per provare un po’ di cover riarrangiate e scambiare idee su testi e armonie. Portate chitarre acustiche, cajon o anche solo la vostra voce!',
    targetInstruments: ['Chitarra Acustica', 'Percussioni', 'Voce'],
